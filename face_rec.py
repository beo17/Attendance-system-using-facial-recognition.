...
def main():
    ...
    parser.add_argument('--path', help='video/video1.mp4', default=0)
    args = parser.parse_args()
     # Kích thước video và tốc độ khung hình của video mới
    ...
    VIDEO_PATH = 'C:\\Users\\DELL\\Desktop\\FaceRecog-facenet\\video\\tonghop4.mp4'
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            output_width = int(cap.get(3))  # Lấy chiều rộng của video gốc
            output_height = int(cap.get(4))  # Lấy chiều cao của video gốc
            output_frame_rate = 30  # Tốc độ khung hình của video mới (fps)
            def get_frame_dimensions():
                return output_height, output_width
            
            height, width = get_frame_dimensions()
            print("Height:", height)
            print("Width:", width)
            ...
            out = cv2.VideoWriter('output_video.avi', fourcc, output_frame_rate, (output_width, output_height))
        ...
        # Tiếp tục xử lý frame đã thay đổi kích thước
                    else:
                            ...
                            for i in range(faces_found):
                                ...
                                if best_class_probabilities > 0.8:
                                    ...
                                    if secondsElapsed > 7200:           # lớn hơn 2 tiếng
                                        ...
                                        change.update({'id':studentInfo['id'], 'status': '1' })
